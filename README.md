...
- Morning Brief has a metadata-only preview foundation and has entered real-input contract work for Gmail, Calendar, and optional Drive metadata. It does not schedule delivery, send notifications, generate live briefs from Google data, or read live Google data directly; Google data may only enter through governed T0 read adapters, not through background sync.
