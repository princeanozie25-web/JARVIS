...
- Agent Runtime has a shared contract, registry, planner, dry-run executor, output factory, and preview agents for Life Coach, Build Monitor, Research Agent, CV Maintenance, Application Tracker, and Deadline Agent. These previews target future Suggestion Inbox compatibility but do not write inbox entries.
