...
export default function GauntletPage() {
  return (
    <main
      ...
      data-gauntlet-surface-style="cinematic-galaxy-hud"
      data-gauntlet-cinematic-shell="true"
      className="jarvis-gauntlet-cinematic min-h-screen overflow-hidden px-3 py-3 text-ink sm:px-5 sm:py-5"
    >
      ...
      <div className="relative grid min-h-[calc(100vh-2.5rem)] gap-3 lg:grid-cols-[320px_minmax(0,1fr)]">
        <aside
        ...
        <section
          ...
          aria-label="Cinematic Infinity Gauntlet"
