...
import { APPROVAL_EXECUTION_VERIFICATION_AUDIT_PREVIEW_CONTRACT_VERSION } from "./execution-verification-audit-preview";
import { APPROVAL_EXECUTION_VERIFICATION_CONTRACT_VERSION } from "./execution-verification";
import { APPROVAL_EXECUTION_VERIFICATION_VALIDATION_CONTRACT_VERSION } from "./execution-verification-validation";
...
export const APPROVAL_RUNTIME_PHASE_18F_CLOSEOUT_VERSION = "18F.4" as const;

export const APPROVAL_RUNTIME_PHASE_18F_SLICES = [
  "18F.1",
  "18F.2",
  "18F.3",
  "18F.4",
...
export const ApprovalRuntimePhase18FCloseoutGuardSchema = z.strictObject({
  phase: z.literal(18),
  closeout_slice: z.literal(APPROVAL_RUNTIME_PHASE_18F_CLOSEOUT_VERSION),
  closeout_id: z.literal("approval_runtime_phase_18f_closeout_guard"),
  ...
  execution_verification_contract_version: z.literal(
    APPROVAL_EXECUTION_VERIFICATION_CONTRACT_VERSION,
  ),
  execution_verification_validation_contract_version: z.literal(
    APPROVAL_EXECUTION_VERIFICATION_VALIDATION_CONTRACT_VERSION,
  ),
  execution_verification_audit_preview_contract_version: z.literal(
    APPROVAL_EXECUTION_VERIFICATION_AUDIT_PREVIEW_CONTRACT_VERSION,
  ),
  slices_closed: z.array(z.enum(APPROVAL_RUNTIME_PHASE_18F_SLICES)),
  metadata_only: z.literal(true),
  execution_verification_layer_only: z.literal(true),
  inert: z.literal(true),
  non_verifying: z.literal(true),
...
export type ApprovalRuntimePhase18FCloseoutGuard = z.infer<
  typeof ApprovalRuntimePhase18FCloseoutGuardSchema
>;

export const DEFAULT_APPROVAL_RUNTIME_PHASE_18F_CLOSEOUT_GUARD =
  ApprovalRuntimePhase18FCloseoutGuardSchema.parse({
    phase: 18,
    closeout_slice: APPROVAL_RUNTIME_PHASE_18F_CLOSEOUT_VERSION,
    ...
    phase_18e_foundation_closeout_version:
      APPROVAL_RUNTIME_PHASE_18E_CLOSEOUT_VERSION,
    execution_verification_contract_version:
      APPROVAL_EXECUTION_VERIFICATION_CONTRACT_VERSION,
    execution_verification_validation_contract_version:
      APPROVAL_EXECUTION_VERIFICATION_VALIDATION_CONTRACT_VERSION,
    execution_verification_audit_preview_contract_version:
      APPROVAL_EXECUTION_VERIFICATION_AUDIT_PREVIEW_CONTRACT_VERSION,
    slices_closed: APPROVAL_RUNTIME_PHASE_18F_SLICES,
    metadata_only: true,
