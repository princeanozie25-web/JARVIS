...
export type VoicePrivacyDecision =
  | {
      ...
      readonly content_class: VoicePrivacyContentClass;
      readonly reason: null;
      readonly redaction_status: "metadata_only";
    }
  | {
      readonly allowed: false;
      readonly content_class: VoicePrivacyContentClass | null;
...
export function classifyVoiceContentPrivacy(
  ...
  return deny(contentClass, denialReasonForContentClass(contentClass));
}
...
function denialReasonForContentClass(
...
function deny(
  contentClass: VoicePrivacyContentClass | null,
