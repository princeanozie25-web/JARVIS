...
describe("ToolRegistry", () => {
  ...
  it("does not register unapproved write/directory-delete/terminal tools", () => {
    expect(
      tools
        .list()
      ...
      ["doc.read_txt", "PURE_READ", "ALLOW"],
      ["doc.read_pdf", "PURE_READ", "ALLOW"],
      ["doc.read_docx", "PURE_READ", "ALLOW"],
      ...
      ["project.summarize", "PURE_READ", "ALLOW"],
