...
E-008 | Phase 13 registry-pin reshape | frozen test files tests/models/registry.test.ts, phase-13a-closeout.test.ts, resolver.test.ts | Deep-equal ID censuses froze the catalog as data, contradicting 23A T4 doctrine + 21A living-catalog premise; reshaped to baseline-preservation + universal schema assertions | APPROVED
