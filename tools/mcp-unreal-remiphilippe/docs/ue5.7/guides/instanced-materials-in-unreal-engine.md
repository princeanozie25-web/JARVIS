...
Any Material instances created from **M_Chair** inherit all the attributes from the graph shown above.
...
1. The prefix **M\_** denotes a parent Material, as in **M_Chair**.
