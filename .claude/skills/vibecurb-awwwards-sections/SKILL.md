...
> _"Page Read: SaaS landing for technical PMs. Conversion goal: start free trial. Objection sequence: (1) 'what does it actually do?' → feature showcase needed, (2) 'who else uses this?' → social proof needed, (3) 'what does it cost?' → pricing needed, (4) 'is the team legit?' → brief about section. Hero established: dark mode, Geist typography, muted indigo accent, cinematic center architecture. Sections must continue this palette and type system."_
...
_Best for: products with 4-6 distinct features of varying importance_
...
_Best for: products with 2-3 major features that each deserve dedicated space_
...
_Best for: one hero feature that defines the product, or a product demo/video section_
...
_Best for: B2B SaaS with recognizable client logos_
...
_Best for: service businesses, agencies, consumer products - where human voice sells_
...
_Best for: products with impressive numbers - users, revenue processed, uptime, speed_
...
_Best for: 3-5 step processes, onboarding flows, service delivery timelines_
...
_Best for: simple 3-step processes, visual learners, SaaS onboarding_
...
_Best for: agencies, studios, portfolios with visual work_
...
_Best for: one flagship case study that tells a story_
...
_Best for: SaaS with 2-3 plans_
...
_Best for: complex products with many differentiating features_
...
_Best for: 5-8 common questions_
...
_Best for: any page - this is the universal closer_
...
_Best for: pages where you want to show a visual alongside the final push_
...
_Best for: landing pages, product launches - pages with a single conversion goal_
...
_Best for: multi-page sites, SaaS products, agencies - where navigation matters_
